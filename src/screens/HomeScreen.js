import { View, Text, StatusBar, StyleSheet, TextInput, Image, ScrollView, TouchableOpacity, Dimensions, SafeAreaView,Platform } from 'react-native'
        ...
        <SafeAreaView style={styles.container}>
            ...
            {OrientationStatus == 'PortraitMode' ?
                ...
                <>
                    ...
                    >
                        ...
                        <View style={styles.header_container}>
                            <Feather name='bell' color={'white'} onPress={() => navigation.navigate('Notifications')}
                                size={30} style={styles.bell} />
                            <Text style={styles.header_Text}>Hi,James Robert</Text>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: '3%', flexWrap: 'wrap' }}>
                            {
                                ...
                                categoriesData.length != 0 ?
                                    ...
                                    categoriesData.map((item, index) => (
                                        index > 1 &&
                                        <TouchableOpacity key={item.cat_id} onPress={() => navigation.navigate('SelectService', { data: servicesData.kidsHaircuts })} style={styles.ViewContainer} >
                                            <View>
                                                <Image
                                                    style={styles.Image}
                                            ...
                                            <View >
                                                ...
                                                <Text style={styles.category_textInput}>{item.name}</Text>
                                            </View>
                                        </TouchableOpacity>
                                    ))
                                    ...
                                    <>
                                        {
                                            [1, 2, 3, 4, 5].map((item, index) => (
                                                <TouchableOpacity key={index} onPress={() => navigation.navigate('SelectService', { data: servicesData.theCompleteLook })} style={styles.ViewContainer}>
                                                    ...
                                                    <View>
                                                        ...
                                                        <Text style={styles.category_textInput}>Loading...</Text>
                                                    </View>
                                                </TouchableOpacity>
                                            ))
                                        }
                ...
                >
                    ...
                    <View style={styles.header_container}>
                        <Feather name='bell' color={'white'} size={30} onPress={() => navigation.navigate('Notifications')}
                            style={[styles.bell, { marginTop: '4%' }]} />
                        <Text style={styles.header_Text}>Hi,James Robert</Text>
                        <Text style={styles.header_Text1}>Book what do u love</Text>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: '3%', flexWrap: 'wrap' }}>
...

                            {
                                ...
                                categoriesData.length != 0 ?
                                    ...
                                    categoriesData.map((item, index) => (
                                        index > 1 &&
                                        <TouchableOpacity key={item.cat_id} onPress={() => navigation.navigate('SelectService', { data: servicesData.kidsHaircuts })} style={[styles.ViewContainer, { width: '24%' }]} >
                                            <View>
                                                <Image
                                                    style={styles.Image}
                                                    source={{ uri: item.imagePath + item.image }}
                                    ...
                                    <>
                                        {
                                            [1, 2, 3, 4, 5].map((item, index) => (
                                                <TouchableOpacity key={index} onPress={() => navigation.navigate('SelectService', { data: servicesData.theCompleteLook })} style={[styles.ViewContainer, { width: '24%' }]} >
                            ...
                            {/* <TouchableOpacity onPress={() => navigation.navigate('SelectService', { data: servicesData.kidsHaircuts })} style={[styles.ViewContainer, { width: '25%' }]} >
                                <View>
                                    <Image
                                        style={styles.Image}
